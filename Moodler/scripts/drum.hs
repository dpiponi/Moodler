do
    ...
    vca45  <-  new' "vca"
    vca46  <-  new' "vca"
    container396 <- container' "panel_3x1.png" (x+(-444.0), y+(804.0)) root
    in399 <- plugin' (butterlp398 ++ "." ++ "freq") (x+(-465.0), y+(829.0)) container396
    setColour in399 "#control"
    hide in399
    in400 <- plugin' (butterlp398 ++ "." ++ "signal") (x+(-465.0), y+(779.0)) container396
    setColour in400 "#sample"
    knob402 <- knob' (butterlp398_freq ++ "." ++ "result") (x+(-465.0), y+(829.0)) container396
    label397 <- label' "butterlp" (x+(-469.0), y+(879.0)) container396
    out401 <- plugout' (butterlp398 ++ "." ++ "result") (x+(-424.0), y+(804.0)) container396
    setColour out401 "#sample"
    container3 <- container' "panel_3x1.png" (x+(-552.0), y+(804.0)) root
    in6 <- plugin' (exp_decay5 ++ "." ++ "decay_time") (x+(-573.0), y+(829.0)) container3
    setColour in6 "#control"
    hide in6
    in7 <- plugin' (exp_decay5 ++ "." ++ "trigger") (x+(-573.0), y+(779.0)) container3
    setColour in7 "#control"
    knob29 <- knob' (exp_decay5_decay_time ++ "." ++ "result") (x+(-573.0), y+(829.0)) container3
    label4 <- label' "exp_decay" (x+(-577.0), y+(879.0)) container3
    out8 <- plugout' (exp_decay5 ++ "." ++ "result") (x+(-532.0), y+(804.0)) container3
    setColour out8 "#control"
    container11 <- container' "panel_lfo.png" (x+(-804.0), y+(756.0)) root
    in12 <- plugin' (lfo10 ++ "." ++ "sync") (x+(-792.0), y+(780.0)) container11
    setColour in12 "#control"
    in13 <- plugin' (lfo10 ++ "." ++ "rate") (x+(-807.0), y+(811.0)) container11
    setColour in13 "#control"
    hide in13
    knob14 <- knob' (input9 ++ "." ++ "result") (x+(-792.0), y+(828.0)) container11
    out15 <- plugout' (lfo10 ++ "." ++ "triangle") (x+(-816.0), y+(636.0)) container11
    setColour out15 "#control"
    out16 <- plugout' (lfo10 ++ "." ++ "saw") (x+(-756.0), y+(636.0)) container11
    setColour out16 "#control"
    out17 <- plugout' (lfo10 ++ "." ++ "sin_result") (x+(-816.0), y+(672.0)) container11
    setColour out17 "#control"
    out18 <- plugout' (lfo10 ++ "." ++ "square_result") (x+(-756.0), y+(672.0)) container11
    setColour out18 "#control"
    container19 <- container' "panel_3x1.png" (x+(-792.0), y+(468.0)) root
    label20 <- label' "noise" (x+(-817.0), y+(543.0)) container19
    out22 <- plugout' (noise21 ++ "." ++ "result") (x+(-772.0), y+(468.0)) container19
    setColour out22 "#sample"
    container266 <- container' "panel_vco2.png" (x+(-588.0), y+(276.0)) root
    in267 <- plugin' (id261 ++ "." ++ "signal") (x+(-552.0), y+(312.0)) container266
    setColour in267 "#control"
    in268 <- plugin' (id262 ++ "." ++ "signal") (x+(-575.0), y+(356.0)) container266
    setColour in268 "#sample"
    hide in268
    in269 <- plugin' (id255 ++ "." ++ "signal") (x+(-557.0), y+(279.0)) container266
    setColour in269 "#sample"
    hide in269
    in270 <- plugin' (id256 ++ "." ++ "signal") (x+(-552.0), y+(240.0)) container266
    setColour in270 "#control"
    knob271 <- knob' (input264 ++ "." ++ "result") (x+(-552.0), y+(276.0)) container266
    knob272 <- knob' (input263 ++ "." ++ "result") (x+(-552.0), y+(348.0)) container266
    out273 <- plugout' (id260 ++ "." ++ "result") (x+(-612.0), y+(192.0)) container266
    setColour out273 "#sample"
    out274 <- plugout' (id257 ++ "." ++ "result") (x+(-540.0), y+(192.0)) container266
    setColour out274 "#sample"
    out275 <- plugout' (id258 ++ "." ++ "result") (x+(-612.0), y+(156.0)) container266
    setColour out275 "#sample"
    out276 <- plugout' (id259 ++ "." ++ "result") (x+(-540.0), y+(156.0)) container266
    setColour out276 "#sample"
    proxy277 <- proxy' (x+(-635.0), y+(358.0)) container266
    hide proxy277
    ...
    container333 <- container' "panel_vco2.png" (x+(-396.0), y+(168.0)) root
    in334 <- plugin' (id328 ++ "." ++ "signal") (x+(-360.0), y+(204.0)) container333
    setColour in334 "#control"
    in335 <- plugin' (id329 ++ "." ++ "signal") (x+(-383.0), y+(248.0)) container333
    setColour in335 "#sample"
    hide in335
    in336 <- plugin' (id322 ++ "." ++ "signal") (x+(-365.0), y+(171.0)) container333
    setColour in336 "#sample"
    hide in336
    in337 <- plugin' (id323 ++ "." ++ "signal") (x+(-360.0), y+(132.0)) container333
    setColour in337 "#control"
    knob338 <- knob' (input331 ++ "." ++ "result") (x+(-360.0), y+(168.0)) container333
    knob339 <- knob' (input330 ++ "." ++ "result") (x+(-360.0), y+(240.0)) container333
    out340 <- plugout' (id327 ++ "." ++ "result") (x+(-420.0), y+(84.0)) container333
    setColour out340 "#sample"
    out341 <- plugout' (id324 ++ "." ++ "result") (x+(-348.0), y+(84.0)) container333
    setColour out341 "#sample"
    out342 <- plugout' (id325 ++ "." ++ "result") (x+(-420.0), y+(48.0)) container333
    setColour out342 "#sample"
    out343 <- plugout' (id326 ++ "." ++ "result") (x+(-348.0), y+(48.0)) container333
    setColour out343 "#sample"
    proxy344 <- proxy' (x+(-443.0), y+(250.0)) container333
    hide proxy344
    ...
    container379 <- container' "panel_4x1.png" (x+(-384.0), y+(504.0)) root
    in382 <- plugin' (sum4381 ++ "." ++ "signal1") (x+(-405.0), y+(579.0)) container379
    setColour in382 "#sample"
    in383 <- plugin' (sum4381 ++ "." ++ "signal2") (x+(-405.0), y+(529.0)) container379
    setColour in383 "#sample"
    in384 <- plugin' (sum4381 ++ "." ++ "signal3") (x+(-405.0), y+(479.0)) container379
    setColour in384 "#sample"
    in385 <- plugin' (sum4381 ++ "." ++ "signal4") (x+(-405.0), y+(429.0)) container379
    setColour in385 "#sample"
    label380 <- label' "sum4" (x+(-409.0), y+(579.0)) container379
    out386 <- plugout' (sum4381 ++ "." ++ "result") (x+(-364.0), y+(504.0)) container379
    setColour out386 "#sample"
    container47 <- container' "panel_filter.png" (x+(-576.0), y+(576.0)) root
    in48 <- plugin' (vca44 ++ "." ++ "cv") (x+(-588.0), y+(696.0)) container47
    setColour in48 "#sample"
    hide in48
    in49 <- plugin' (vca44 ++ "." ++ "signal") (x+(-636.0), y+(636.0)) container47
    setColour in49 "#control"
    in50 <- plugin' (vca45 ++ "." ++ "cv") (x+(-593.0), y+(574.0)) container47
    setColour in50 "#sample"
    hide in50
    in51 <- plugin' (vca45 ++ "." ++ "signal") (x+(-636.0), y+(576.0)) container47
    setColour in51 "#control"
    in52 <- plugin' (vca46 ++ "." ++ "cv") (x+(-595.0), y+(458.0)) container47
    setColour in52 "#sample"
    hide in52
    in53 <- plugin' (vca46 ++ "." ++ "signal") (x+(-636.0), y+(516.0)) container47
    setColour in53 "#control"
    in54 <- plugin' (id33 ++ "." ++ "signal") (x+(-636.0), y+(696.0)) container47
    setColour in54 "#control"
    knob55 <- knob' (input40 ++ "." ++ "result") (x+(-552.0), y+(636.0)) container47
    setLow knob55 (Just (-1.0))
    setHigh  knob55 (Just (1.0))
    knob56 <- knob' (input34 ++ "." ++ "result") (x+(-600.0), y+(636.0)) container47
    knob57 <- knob' (input35 ++ "." ++ "result") (x+(-600.0), y+(576.0)) container47
    knob58 <- knob' (input36 ++ "." ++ "result") (x+(-552.0), y+(576.0)) container47
    setLow knob58 (Just (-1.0))
    setHigh  knob58 (Just (1.0))
    knob59 <- knob' (input37 ++ "." ++ "result") (x+(-600.0), y+(516.0)) container47
    knob60 <- knob' (input38 ++ "." ++ "result") (x+(-552.0), y+(516.0)) container47
    setLow knob60 (Just (-1.0))
    setHigh  knob60 (Just (1.0))
    knob61 <- knob' (input39 ++ "." ++ "result") (x+(-552.0), y+(468.0)) container47
    setLow knob61 (Just (1.0))
    setHigh  knob61 (Just (1000.0))
    out62 <- plugout' (butterbp30 ++ "." ++ "result") (x+(-516.0), y+(516.0)) container47
    setColour out62 "#sample"
    out63 <- plugout' (butterlp32 ++ "." ++ "result") (x+(-516.0), y+(636.0)) container47
    setColour out63 "#sample"
    out64 <- plugout' (butterhp31 ++ "." ++ "result") (x+(-516.0), y+(576.0)) container47
    setColour out64 "#sample"
    proxy65 <- proxy' (x+(-527.0), y+(686.0)) container47
    hide proxy65
    ...
    container128 <- container' "panel_mixer.png" (x+(-108.0), y+(588.0)) root
    in129 <- plugin' (id97 ++ "." ++ "signal") (x+(-132.0), y+(612.0)) container128
    setColour in129 "#control"
    hide in129
    in130 <- plugin' (id98 ++ "." ++ "signal") (x+(-60.0), y+(612.0)) container128
    setColour in130 "#control"
    hide in130
    in131 <- plugin' (id96 ++ "." ++ "signal") (x+(-84.0), y+(612.0)) container128
    setColour in131 "#control"
    in132 <- plugin' (audio_id90 ++ "." ++ "signal") (x+(-180.0), y+(612.0)) container128
    setColour in132 "#sample"
    in133 <- plugin' (id101 ++ "." ++ "signal") (x+(-132.0), y+(540.0)) container128
    setColour in133 "#control"
    hide in133
    in134 <- plugin' (id102 ++ "." ++ "signal") (x+(-60.0), y+(540.0)) container128
    setColour in134 "#control"
    hide in134
    in135 <- plugin' (id100 ++ "." ++ "signal") (x+(-84.0), y+(540.0)) container128
    setColour in135 "#control"
    in136 <- plugin' (audio_id94 ++ "." ++ "signal") (x+(-180.0), y+(540.0)) container128
    setColour in136 "#sample"
    in137 <- plugin' (id103 ++ "." ++ "signal") (x+(-132.0), y+(576.0)) container128
    setColour in137 "#control"
    hide in137
    in138 <- plugin' (id104 ++ "." ++ "signal") (x+(-60.0), y+(576.0)) container128
    setColour in138 "#control"
    hide in138
    in139 <- plugin' (id99 ++ "." ++ "signal") (x+(-84.0), y+(576.0)) container128
    setColour in139 "#control"
    in140 <- plugin' (audio_id92 ++ "." ++ "signal") (x+(-180.0), y+(576.0)) container128
    setColour in140 "#sample"
    in141 <- plugin' (id105 ++ "." ++ "signal") (x+(-132.0), y+(648.0)) container128
    setColour in141 "#control"
    hide in141
    in142 <- plugin' (id106 ++ "." ++ "signal") (x+(-60.0), y+(648.0)) container128
    setColour in142 "#control"
    hide in142
    in143 <- plugin' (id95 ++ "." ++ "signal") (x+(-84.0), y+(648.0)) container128
    setColour in143 "#control"
    in144 <- plugin' (audio_id87 ++ "." ++ "signal") (x+(-180.0), y+(648.0)) container128
    setColour in144 "#sample"
    knob145 <- knob' (input107 ++ "." ++ "result") (x+(-132.0), y+(612.0)) container128
    knob146 <- knob' (input108 ++ "." ++ "result") (x+(-48.0), y+(612.0)) container128
    knob147 <- knob' (input109 ++ "." ++ "result") (x+(-132.0), y+(540.0)) container128
    knob148 <- knob' (input110 ++ "." ++ "result") (x+(-48.0), y+(540.0)) container128
    knob149 <- knob' (input111 ++ "." ++ "result") (x+(-132.0), y+(576.0)) container128
    knob150 <- knob' (input112 ++ "." ++ "result") (x+(-48.0), y+(576.0)) container128
    knob151 <- knob' (input113 ++ "." ++ "result") (x+(-132.0), y+(648.0)) container128
    knob152 <- knob' (input114 ++ "." ++ "result") (x+(-48.0), y+(648.0)) container128
    out153 <- plugout' (audio_id89 ++ "." ++ "result") (x+(-48.0), y+(480.0)) container128
    setColour out153 "#sample"
    proxy154 <- proxy' (x+(-168.0), y+(480.0)) container128
    hide proxy154
    ...
    container23 <- container' "panel_3x1.png" (x+(-288.0), y+(624.0)) root
    in26 <- plugin' (vca25 ++ "." ++ "cv") (x+(-309.0), y+(649.0)) container23
    setColour in26 "#control"
    in27 <- plugin' (vca25 ++ "." ++ "signal") (x+(-309.0), y+(599.0)) container23
    setColour in27 "#sample"
    label24 <- label' "vca" (x+(-313.0), y+(699.0)) container23
    out28 <- plugout' (vca25 ++ "." ++ "result") (x+(-268.0), y+(624.0)) container23
