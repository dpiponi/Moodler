do
    ...
    vca86  <-  new' "vca"
    vca87  <-  new' "vca"
    in88 <- plugin' (id17 ++ "." ++ "signal") (x+(-192.0), y+(132.0)) (Inside root)
    rename "frequency" in88
    in89 <- plugin' (id18 ++ "." ++ "signal") (x+(-192.0), y+(72.0)) (Inside root)
    out90 <- plugout' (id27 ++ "." ++ "result") (x+(-60.0), y+(96.0)) (Inside root)
    proxy91 <- proxy' (x+(-132.0), y+(96.0)) (Inside root)
    container102 <- container' "panel_3x1.png" (-108.0,0.0) (Inside proxy91)
    in103 <- plugin' (vca85 ++ "." ++ "cv") (-134.0,26.5) (Outside container102)
    hide in103
    in104 <- plugin' (vca85 ++ "." ++ "signal") (-132.0,-24.0) (Outside container102)
    knob105 <- knob' (input58 ++ "." ++ "result") (-132.0,24.0) (Outside container102)
    label106 <- label' "vca" (-132.0,72.0) (Outside container102)
    out107 <- plugout' (vca85 ++ "." ++ "result") (-96.0,0.0) (Outside container102)
    container108 <- container' "panel_3x1.png" (-504.0,-12.0) (Inside proxy91)
    in109 <- plugin' (vca83 ++ "." ++ "cv") (-531.0,13.5) (Outside container108)
    hide in109
    in110 <- plugin' (vca83 ++ "." ++ "signal") (-528.0,-36.0) (Outside container108)
    knob111 <- knob' (input68 ++ "." ++ "result") (-528.0,12.0) (Outside container108)
    rename "adsr->freqency gain" knob111
    label112 <- label' "vca" (-540.0,60.0) (Outside container108)
    out113 <- plugout' (vca83 ++ "." ++ "result") (-492.0,-12.0) (Outside container108)
    container114 <- container' "panel_vco2.png" (-504.0,288.0) (Inside proxy91)
    in115 <- plugin' (id20 ++ "." ++ "signal") (-468.0,324.0) (Outside container114)
    in116 <- plugin' (id21 ++ "." ++ "signal") (-494.0,360.5) (Outside container114)
    hide in116
    in117 <- plugin' (id22 ++ "." ++ "signal") (-493.0,285.5) (Outside container114)
    hide in117
    in118 <- plugin' (id23 ++ "." ++ "signal") (-468.0,252.0) (Outside container114)
    knob119 <- knob' (input57 ++ "." ++ "result") (-468.0,360.0) (Outside container114)
    knob120 <- knob' (input54 ++ "." ++ "result") (-468.0,288.0) (Outside container114)
    out121 <- plugout' (id19 ++ "." ++ "result") (-528.0,204.0) (Outside container114)
    out122 <- plugout' (id24 ++ "." ++ "result") (-456.0,204.0) (Outside container114)
    out123 <- plugout' (id25 ++ "." ++ "result") (-528.0,168.0) (Outside container114)
    out124 <- plugout' (id26 ++ "." ++ "result") (-456.0,168.0) (Outside container114)
    proxy125 <- proxy' (-554.0,362.5) (Outside container114)
    hide proxy125
    ...
    container160 <- container' "panel_vco2.png" (-324.0,288.0) (Inside proxy91)
    in161 <- plugin' (id29 ++ "." ++ "signal") (-288.0,324.0) (Outside container160)
    in162 <- plugin' (id30 ++ "." ++ "signal") (-307.0,369.5) (Outside container160)
    hide in162
    in163 <- plugin' (id31 ++ "." ++ "signal") (-306.0,294.5) (Outside container160)
    hide in163
    in164 <- plugin' (id32 ++ "." ++ "signal") (-288.0,252.0) (Outside container160)
    knob165 <- knob' (input59 ++ "." ++ "result") (-288.0,360.0) (Outside container160)
    knob166 <- knob' (input55 ++ "." ++ "result") (-288.0,288.0) (Outside container160)
    out167 <- plugout' (id28 ++ "." ++ "result") (-348.0,204.0) (Outside container160)
    out168 <- plugout' (id33 ++ "." ++ "result") (-276.0,204.0) (Outside container160)
    out169 <- plugout' (id34 ++ "." ++ "result") (-348.0,168.0) (Outside container160)
    out170 <- plugout' (id35 ++ "." ++ "result") (-276.0,168.0) (Outside container160)
    ...
    container206 <- container' "panel_vco2.png" (-132.0,288.0) (Inside proxy91)
    in207 <- plugin' (id37 ++ "." ++ "signal") (-96.0,324.0) (Outside container206)
    in208 <- plugin' (id38 ++ "." ++ "signal") (-111.0,361.5) (Outside container206)
    hide in208
    in209 <- plugin' (id39 ++ "." ++ "signal") (-110.0,286.5) (Outside container206)
    hide in209
    in210 <- plugin' (id40 ++ "." ++ "signal") (-96.0,252.0) (Outside container206)
    knob211 <- knob' (input64 ++ "." ++ "result") (-96.0,360.0) (Outside container206)
    knob212 <- knob' (input56 ++ "." ++ "result") (-96.0,288.0) (Outside container206)
    out213 <- plugout' (id36 ++ "." ++ "result") (-156.0,204.0) (Outside container206)
    out214 <- plugout' (id41 ++ "." ++ "result") (-84.0,204.0) (Outside container206)
    out215 <- plugout' (id42 ++ "." ++ "result") (-156.0,168.0) (Outside container206)
    out216 <- plugout' (id43 ++ "." ++ "result") (-84.0,168.0) (Outside container206)
    ...
    container252 <- container' "panel_lfo.png" (-480.0,-864.0) (Inside proxy91)
    in253 <- plugin' (lfo70 ++ "." ++ "sync") (-468.0,-840.0) (Outside container252)
    in254 <- plugin' (lfo70 ++ "." ++ "rate") (-482.5,-788.0) (Outside container252)
    hide in254
    knob255 <- knob' (input67 ++ "." ++ "result") (-468.0,-792.0) (Outside container252)
    out256 <- plugout' (lfo70 ++ "." ++ "saw") (-492.0,-984.0) (Outside container252)
    out257 <- plugout' (lfo70 ++ "." ++ "triangle") (-432.0,-984.0) (Outside container252)
    out258 <- plugout' (lfo70 ++ "." ++ "sin_result") (-492.0,-948.0) (Outside container252)
    out259 <- plugout' (lfo70 ++ "." ++ "square_result") (-432.0,-948.0) (Outside container252)
    container260 <- container' "panel_3x1.png" (-108.0,-312.0) (Inside proxy91)
    in261 <- plugin' (sum76 ++ "." ++ "signal1") (-120.0,-288.0) (Outside container260)
    in262 <- plugin' (sum76 ++ "." ++ "signal2") (-120.0,-336.0) (Outside container260)
    label263 <- label' "sum" (-132.0,-228.0) (Outside container260)
    out264 <- plugout' (sum76 ++ "." ++ "result") (-84.0,-312.0) (Outside container260)
    container265 <- container' "panel_3x1.png" (-120.0,-588.0) (Inside proxy91)
    in266 <- plugin' (vca80 ++ "." ++ "cv") (-146.0,-566.5) (Outside container265)
    hide in266
    in267 <- plugin' (vca80 ++ "." ++ "signal") (-144.0,-612.0) (Outside container265)
    knob268 <- knob' (input50 ++ "." ++ "result") (-144.0,-564.0) (Outside container265)
    label269 <- label' "vca" (-144.0,-516.0) (Outside container265)
    out270 <- plugout' (vca80 ++ "." ++ "result") (-108.0,-588.0) (Outside container265)
    container271 <- container' "panel_3x1.png" (12.0,-576.0) (Inside proxy91)
    in272 <- plugin' (vca81 ++ "." ++ "cv") (-14.0,-552.5) (Outside container271)
    hide in272
    in273 <- plugin' (vca81 ++ "." ++ "signal") (-12.0,-600.0) (Outside container271)
    knob274 <- knob' (input51 ++ "." ++ "result") (-14.0,-552.5) (Outside container271)
    hide knob274
    knob275 <- knob' (input52 ++ "." ++ "result") (-12.0,-552.0) (Outside container271)
    label276 <- label' "vca" (-12.0,-504.0) (Outside container271)
    out277 <- plugout' (vca81 ++ "." ++ "result") (24.0,-576.0) (Outside container271)
    container278 <- container' "panel_3x1.png" (-108.0,-840.0) (Inside proxy91)
    in279 <- plugin' (vca82 ++ "." ++ "cv") (-128.0,-815.5) (Outside container278)
    hide in279
    in280 <- plugin' (vca82 ++ "." ++ "signal") (-132.0,-864.0) (Outside container278)
    knob281 <- knob' (input53 ++ "." ++ "result") (-132.0,-816.0) (Outside container278)
    label282 <- label' "vca" (-132.0,-768.0) (Outside container278)
    out283 <- plugout' (vca82 ++ "." ++ "result") (-84.0,-840.0) (Outside container278)
    container284 <- container' "panel_adsr.png" (-336.0,-612.0) (Inside proxy91)
    ...
    hide in288
    in289 <- plugin' (adsr4 ++ "." ++ "gate") (-300.0,-684.0) (Outside container284)
    knob290 <- knob' (input46 ++ "." ++ "result") (-372.0,-564.0) (Outside container284)
    knob291 <- knob' (input47 ++ "." ++ "result") (-300.0,-564.0) (Outside container284)
    knob292 <- knob' (input49 ++ "." ++ "result") (-372.0,-624.0) (Outside container284)
    knob293 <- knob' (input48 ++ "." ++ "result") (-300.0,-624.0) (Outside container284)
    out294 <- plugout' (adsr4 ++ "." ++ "result") (-300.0,-720.0) (Outside container284)
    container295 <- container' "panel_adsr.png" (-384.0,-312.0) (Inside proxy91)
    ...
    hide in299
    in300 <- plugin' (adsr3 ++ "." ++ "gate") (-360.0,-384.0) (Outside container295)
    knob301 <- knob' (input60 ++ "." ++ "result") (-420.0,-252.0) (Outside container295)
    knob302 <- knob' (input61 ++ "." ++ "result") (-360.0,-252.0) (Outside container295)
    knob303 <- knob' (input66 ++ "." ++ "result") (-432.0,-312.0) (Outside container295)
    knob304 <- knob' (input65 ++ "." ++ "result") (-360.0,-312.0) (Outside container295)
    out305 <- plugout' (adsr3 ++ "." ++ "result") (-360.0,-420.0) (Outside container295)
    container306 <- container' "panel_3x1.png" (0.0,-300.0) (Inside proxy91)
    in307 <- plugin' (vca84 ++ "." ++ "cv") (-24.0,-276.0) (Outside container306)
    in308 <- plugin' (vca84 ++ "." ++ "signal") (-24.0,-324.0) (Outside container306)
    label309 <- label' "vca" (-24.0,-228.0) (Outside container306)
    out310 <- plugout' (vca84 ++ "." ++ "result") (12.0,-300.0) (Outside container306)
    container311 <- container' "panel_3x1.png" (0.0,-12.0) (Inside proxy91)
    in312 <- plugin' (vca86 ++ "." ++ "cv") (-27.0,17.0) (Outside container311)
    hide in312
    in313 <- plugin' (vca86 ++ "." ++ "signal") (-24.0,-36.0) (Outside container311)
    knob314 <- knob' (input45 ++ "." ++ "result") (-24.0,12.0) (Outside container311)
    label315 <- label' "vca" (-36.0,72.0) (Outside container311)
    out316 <- plugout' (vca86 ++ "." ++ "result") (12.0,-12.0) (Outside container311)
    container317 <- container' "panel_3x1.png" (48.0,348.0) (Inside proxy91)
    label318 <- label' "noise" (24.0,420.0) (Outside container317)
    out319 <- plugout' (noise71 ++ "." ++ "result") (60.0,348.0) (Outside container317)
    container320 <- container' "panel_4x1.png" (-336.0,-12.0) (Inside proxy91)
    in321 <- plugin' (sum477 ++ "." ++ "signal1") (-360.0,60.0) (Outside container320)
    in322 <- plugin' (sum477 ++ "." ++ "signal2") (-360.0,12.0) (Outside container320)
    in323 <- plugin' (sum477 ++ "." ++ "signal3") (-360.0,-36.0) (Outside container320)
    in324 <- plugin' (sum477 ++ "." ++ "signal4") (-360.0,-84.0) (Outside container320)
    label325 <- label' "sum4" (-360.0,60.0) (Outside container320)
    out326 <- plugout' (sum477 ++ "." ++ "result") (-324.0,-12.0) (Outside container320)
    container327 <- container' "panel_4x1.png" (348.0,336.0) (Inside proxy91)
    in328 <- plugin' (sum478 ++ "." ++ "signal1") (324.0,408.0) (Outside container327)
    in329 <- plugin' (sum478 ++ "." ++ "signal2") (324.0,360.0) (Outside container327)
    in330 <- plugin' (sum478 ++ "." ++ "signal3") (324.0,300.0) (Outside container327)
    in331 <- plugin' (sum478 ++ "." ++ "signal4") (324.0,264.0) (Outside container327)
    label332 <- label' "sum4" (324.0,408.0) (Outside container327)
    out333 <- plugout' (sum478 ++ "." ++ "result") (372.0,336.0) (Outside container327)
    container334 <- container' "panel_3x1.png" (180.0,348.0) (Inside proxy91)
    in335 <- plugin' (vca87 ++ "." ++ "cv") (155.0,368.0) (Outside container334)
    hide in335
    in336 <- plugin' (vca87 ++ "." ++ "signal") (156.0,324.0) (Outside container334)
    knob337 <- knob' (input44 ++ "." ++ "result") (156.0,372.0) (Outside container334)
    label338 <- label' "vca" (156.0,420.0) (Outside container334)
    out339 <- plugout' (vca87 ++ "." ++ "result") (192.0,348.0) (Outside container334)
    container340 <- container' "panel_4x1.png" (108.0,-36.0) (Inside proxy91)
    in341 <- plugin' (sum479 ++ "." ++ "signal1") (96.0,48.0) (Outside container340)
    in342 <- plugin' (sum479 ++ "." ++ "signal2") (96.0,0.0) (Outside container340)
    in343 <- plugin' (sum479 ++ "." ++ "signal3") (96.0,-60.0) (Outside container340)
    in344 <- plugin' (sum479 ++ "." ++ "signal4") (96.0,-108.0) (Outside container340)
    label345 <- label' "sum4" (84.0,48.0) (Outside container340)
    out346 <- plugout' (sum479 ++ "." ++ "result") (132.0,-36.0) (Outside container340)
    container92 <- container' "panel_ladder.png" (324.0,0.0) (Inside proxy91)
    in93 <- plugin' (ladder69 ++ "." ++ "signal") (276.0,-120.0) (Outside container92)
    in94 <- plugin' (sum72 ++ "." ++ "signal1") (373.0,75.5) (Outside container92)
    hide in94
    in95 <- plugin' (sum72 ++ "." ++ "signal2") (324.0,72.0) (Outside container92)
    in96 <- plugin' (ladder69 ++ "." ++ "freq") (347.0,29.5) (Outside container92)
    hide in96
    in97 <- plugin' (ladder69 ++ "." ++ "res") (370.0,-7.5) (Outside container92)
    hide in97
    knob98 <- knob' (input62 ++ "." ++ "result") (372.0,12.0) (Outside container92)
    knob99 <- knob' (input63 ++ "." ++ "result") (372.0,72.0) (Outside container92)
    out100 <- plugout' (ladder69 ++ "." ++ "result") (372.0,-120.0) (Outside container92)
