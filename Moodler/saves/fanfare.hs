do
    ...
    vca114 <- new' "vca"
    vca115 <- new' "vca"
    container116 <- container' "panel_sequencer.png" (-41.0,328.0) root
    ...
    container173 <- container' "panel_3x1.png" (312.0,-20.0) root
    ...
    container179 <- container' "panel_lfo.png" (-348.52,336.2345) root
    ...
    container196 <- container' "panel_ladder.png" (329.0,1.5) proxy195
    in197 <- plugin' (ladder94 ++ "." ++ "signal") (321.0,-66.5) container196
    in198 <- plugin' (sum106 ++ "." ++ "signal1") (373.0,75.5) container196
    hide in198
    in199 <- plugin' (sum106 ++ "." ++ "signal2") (324.0,76.5) container196
    ...
    out205 <- plugout' (sum106 ++ "." ++ "result") (289.0,32.5) container196
    hide out205
    container206 <- container' "panel_3x1.png" (-113.0,1.5) proxy195
    ...
    container212 <- container' "panel_3x1.png" (-510.0,-11.5) proxy195
    ...
    container218 <- container' "panel_vco2.png" (-510.0,294.0) proxy195
    ...
    in237 <- plugin' (sum99 ++ "." ++ "signal2") (-1116.0,654.5) container236
    in238 <- plugin' (sum99 ++ "." ++ "signal1") (-1116.0,704.5) container236
    label239 <- label' "sum" (-1120.0,754.5) container236
    out240 <- plugout' (sum99 ++ "." ++ "result") (-1075.0,679.5) container236
    ...
    container264 <- container' "panel_vco2.png" (-323.0,291.0) proxy195
    ...
    in283 <- plugin' (sum100 ++ "." ++ "signal2") (-982.0,738.5) container282
    in284 <- plugin' (sum100 ++ "." ++ "signal1") (-982.0,788.5) container282
    label285 <- label' "sum" (-986.0,838.5) container282
    out286 <- plugout' (sum100 ++ "." ++ "result") (-941.0,763.5) container282
    ...
    container310 <- container' "panel_vco2.png" (-127.0,283.0) proxy195
    ...
    in329 <- plugin' (sum101 ++ "." ++ "signal2") (-978.0,737.5) container328
    in330 <- plugin' (sum101 ++ "." ++ "signal1") (-978.0,787.5) container328
    label331 <- label' "sum" (-982.0,837.5) container328
    out332 <- plugout' (sum101 ++ "." ++ "result") (-937.0,762.5) container328
    ...
    container356 <- container' "panel_lfo.png" (-484.5,-862.0) proxy195
    ...
    container364 <- container' "panel_3x1.png" (-105.0,-308.5) proxy195
    in365 <- plugin' (sum102 ++ "." ++ "signal1") (-126.0,-283.5) container364
    in366 <- plugin' (sum102 ++ "." ++ "signal2") (-126.0,-333.5) container364
    label367 <- label' "sum" (-130.0,-233.5) container364
    out368 <- plugout' (sum102 ++ "." ++ "result") (-85.0,-308.5) container364
    container369 <- container' "panel_3x1.png" (-125.0,-591.5) proxy195
    ...
    container375 <- container' "panel_3x1.png" (7.0,-577.5) proxy195
    ...
    container382 <- container' "panel_3x1.png" (-107.0,-840.5) proxy195
    ...
    container388 <- container' "panel_adsr.png" (-333.02,-616.7655) proxy195
    ...
    container399 <- container' "panel_adsr.png" (-385.5,-309.0) proxy195
    ...
    container410 <- container' "panel_3x1.png" (-3.0,-297.5) proxy195
    ...
    container415 <- container' "panel_3x1.png" (-6.0,-8.0) proxy195
    ...
    container421 <- container' "panel_3x1.png" (45.0,346.0) proxy195
    label422 <- label' "noise" (20.0,421.0) container421
    out423 <- plugout' (noise97 ++ "." ++ "result") (65.0,346.0) container421
    container424 <- container' "panel_4x1.png" (-341.0,-12.0) proxy195
    ...
    container431 <- container' "panel_4x1.png" (350.0,330.0) proxy195
    ...
    container438 <- container' "panel_3x1.png" (176.0,343.0) proxy195
    ...
    container444 <- container' "panel_4x1.png" (111.0,-31.0) proxy195
