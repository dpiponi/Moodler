do
    ...
    vca45 <- new' "vca"
    vca46 <- new' "vca"
    container11 <- container' "panel_lfo.png" (-360.0,144.0) (Inside root)
    in12 <- plugin' (lfo10 ++ "." ++ "sync") (-348.0,168.0) (Outside container11)
    setColour in12 "#control"
    in13 <- plugin' (lfo10 ++ "." ++ "rate") (-363.0,199.0) (Outside container11)
    setColour in13 "#control"
    hide in13
    knob14 <- knob' (input9 ++ "." ++ "result") (-348.0,216.0) (Outside container11)
    out15 <- plugout' (lfo10 ++ "." ++ "triangle") (-372.0,24.0) (Outside container11)
    setColour out15 "#control"
    out16 <- plugout' (lfo10 ++ "." ++ "saw") (-312.0,24.0) (Outside container11)
    setColour out16 "#control"
    out17 <- plugout' (lfo10 ++ "." ++ "sin_result") (-372.0,60.0) (Outside container11)
    setColour out17 "#control"
    out18 <- plugout' (lfo10 ++ "." ++ "square_result") (-312.0,60.0) (Outside container11)
    setColour out18 "#control"
    container128 <- container' "panel_mixer.png" (336.0,-24.0) (Inside root)
    in129 <- plugin' (id97 ++ "." ++ "signal") (312.0,0.0) (Outside container128)
    setColour in129 "#control"
    hide in129
    in130 <- plugin' (id98 ++ "." ++ "signal") (384.0,0.0) (Outside container128)
    setColour in130 "#control"
    hide in130
    in131 <- plugin' (id96 ++ "." ++ "signal") (360.0,0.0) (Outside container128)
    setColour in131 "#control"
    in132 <- plugin' (audio_id90 ++ "." ++ "signal") (264.0,0.0) (Outside container128)
    setColour in132 "#sample"
    in133 <- plugin' (id101 ++ "." ++ "signal") (312.0,-72.0) (Outside container128)
    setColour in133 "#control"
    hide in133
    in134 <- plugin' (id102 ++ "." ++ "signal") (384.0,-72.0) (Outside container128)
    setColour in134 "#control"
    hide in134
    in135 <- plugin' (id100 ++ "." ++ "signal") (360.0,-72.0) (Outside container128)
    setColour in135 "#control"
    in136 <- plugin' (audio_id94 ++ "." ++ "signal") (264.0,-72.0) (Outside container128)
    setColour in136 "#sample"
    in137 <- plugin' (id103 ++ "." ++ "signal") (312.0,-36.0) (Outside container128)
    setColour in137 "#control"
    hide in137
    in138 <- plugin' (id104 ++ "." ++ "signal") (384.0,-36.0) (Outside container128)
    setColour in138 "#control"
    hide in138
    in139 <- plugin' (id99 ++ "." ++ "signal") (360.0,-36.0) (Outside container128)
    setColour in139 "#control"
    in140 <- plugin' (audio_id92 ++ "." ++ "signal") (264.0,-36.0) (Outside container128)
    setColour in140 "#sample"
    in141 <- plugin' (id105 ++ "." ++ "signal") (312.0,36.0) (Outside container128)
    setColour in141 "#control"
    hide in141
    in142 <- plugin' (id106 ++ "." ++ "signal") (384.0,36.0) (Outside container128)
    setColour in142 "#control"
    hide in142
    in143 <- plugin' (id95 ++ "." ++ "signal") (360.0,36.0) (Outside container128)
    setColour in143 "#control"
    in144 <- plugin' (audio_id87 ++ "." ++ "signal") (264.0,36.0) (Outside container128)
    setColour in144 "#sample"
    knob145 <- knob' (input107 ++ "." ++ "result") (312.0,0.0) (Outside container128)
    knob146 <- knob' (input108 ++ "." ++ "result") (396.0,0.0) (Outside container128)
    knob147 <- knob' (input109 ++ "." ++ "result") (312.0,-72.0) (Outside container128)
    knob148 <- knob' (input110 ++ "." ++ "result") (396.0,-72.0) (Outside container128)
    knob149 <- knob' (input111 ++ "." ++ "result") (312.0,-36.0) (Outside container128)
    knob150 <- knob' (input112 ++ "." ++ "result") (396.0,-36.0) (Outside container128)
    knob151 <- knob' (input113 ++ "." ++ "result") (312.0,36.0) (Outside container128)
    knob152 <- knob' (input114 ++ "." ++ "result") (396.0,36.0) (Outside container128)
    out153 <- plugout' (audio_id89 ++ "." ++ "result") (396.0,-132.0) (Outside container128)
    setColour out153 "#sample"
    proxy154 <- proxy' (276.0,-132.0) (Outside container128)
    hide proxy154
    ...
    container19 <- container' "panel_3x1.png" (-348.0,-144.0) (Inside root)
    label20 <- label' "noise" (-373.0,-69.0) (Outside container19)
    out22 <- plugout' (noise21 ++ "." ++ "result") (-328.0,-144.0) (Outside container19)
    setColour out22 "#sample"
    container23 <- container' "panel_3x1.png" (156.0,12.0) (Inside root)
    in26 <- plugin' (vca25 ++ "." ++ "cv") (135.0,37.0) (Outside container23)
    setColour in26 "#control"
    in27 <- plugin' (vca25 ++ "." ++ "signal") (135.0,-13.0) (Outside container23)
    setColour in27 "#sample"
    label24 <- label' "vca" (131.0,87.0) (Outside container23)
    out28 <- plugout' (vca25 ++ "." ++ "result") (176.0,12.0) (Outside container23)
    setColour out28 "#sample"
    container266 <- container' "panel_vco2.png" (-144.0,-336.0) (Inside root)
    in267 <- plugin' (id261 ++ "." ++ "signal") (-108.0,-300.0) (Outside container266)
    setColour in267 "#control"
    in268 <- plugin' (id262 ++ "." ++ "signal") (-131.0,-256.0) (Outside container266)
    setColour in268 "#sample"
    hide in268
    in269 <- plugin' (id255 ++ "." ++ "signal") (-113.0,-333.0) (Outside container266)
    setColour in269 "#sample"
    hide in269
    in270 <- plugin' (id256 ++ "." ++ "signal") (-108.0,-372.0) (Outside container266)
    setColour in270 "#control"
    knob271 <- knob' (input264 ++ "." ++ "result") (-108.0,-336.0) (Outside container266)
    knob272 <- knob' (input263 ++ "." ++ "result") (-108.0,-264.0) (Outside container266)
    out273 <- plugout' (id260 ++ "." ++ "result") (-168.0,-420.0) (Outside container266)
    setColour out273 "#sample"
    out274 <- plugout' (id257 ++ "." ++ "result") (-96.0,-420.0) (Outside container266)
    setColour out274 "#sample"
    out275 <- plugout' (id258 ++ "." ++ "result") (-168.0,-456.0) (Outside container266)
    setColour out275 "#sample"
    out276 <- plugout' (id259 ++ "." ++ "result") (-96.0,-456.0) (Outside container266)
    setColour out276 "#sample"
    proxy277 <- proxy' (-191.0,-254.0) (Outside container266)
    hide proxy277
    ...
    container3 <- container' "panel_3x1.png" (-108.0,192.0) (Inside root)
    in6 <- plugin' (exp_decay5 ++ "." ++ "decay_time") (-129.0,217.0) (Outside container3)
    setColour in6 "#control"
    hide in6
    in7 <- plugin' (exp_decay5 ++ "." ++ "trigger") (-129.0,167.0) (Outside container3)
    setColour in7 "#control"
    knob29 <- knob' (exp_decay5_decay_time ++ "." ++ "result") (-129.0,217.0) (Outside container3)
    label4 <- label' "exp_decay" (-133.0,267.0) (Outside container3)
    out8 <- plugout' (exp_decay5 ++ "." ++ "result") (-88.0,192.0) (Outside container3)
    setColour out8 "#control"
    container333 <- container' "panel_vco2.png" (48.0,-444.0) (Inside root)
    in334 <- plugin' (id328 ++ "." ++ "signal") (84.0,-408.0) (Outside container333)
    setColour in334 "#control"
    in335 <- plugin' (id329 ++ "." ++ "signal") (61.0,-364.0) (Outside container333)
    setColour in335 "#sample"
    hide in335
    in336 <- plugin' (id322 ++ "." ++ "signal") (79.0,-441.0) (Outside container333)
    setColour in336 "#sample"
    hide in336
    in337 <- plugin' (id323 ++ "." ++ "signal") (84.0,-480.0) (Outside container333)
    setColour in337 "#control"
    knob338 <- knob' (input331 ++ "." ++ "result") (84.0,-444.0) (Outside container333)
    knob339 <- knob' (input330 ++ "." ++ "result") (84.0,-372.0) (Outside container333)
    out340 <- plugout' (id327 ++ "." ++ "result") (24.0,-528.0) (Outside container333)
    setColour out340 "#sample"
    out341 <- plugout' (id324 ++ "." ++ "result") (96.0,-528.0) (Outside container333)
    setColour out341 "#sample"
    out342 <- plugout' (id325 ++ "." ++ "result") (24.0,-564.0) (Outside container333)
    setColour out342 "#sample"
    out343 <- plugout' (id326 ++ "." ++ "result") (96.0,-564.0) (Outside container333)
    setColour out343 "#sample"
    proxy344 <- proxy' (1.0,-362.0) (Outside container333)
    hide proxy344
    ...
    container379 <- container' "panel_4x1.png" (60.0,-108.0) (Inside root)
    in382 <- plugin' (sum4381 ++ "." ++ "signal1") (39.0,-33.0) (Outside container379)
    setColour in382 "#sample"
    in383 <- plugin' (sum4381 ++ "." ++ "signal2") (39.0,-83.0) (Outside container379)
    setColour in383 "#sample"
    in384 <- plugin' (sum4381 ++ "." ++ "signal3") (39.0,-133.0) (Outside container379)
    setColour in384 "#sample"
    in385 <- plugin' (sum4381 ++ "." ++ "signal4") (39.0,-183.0) (Outside container379)
    setColour in385 "#sample"
    label380 <- label' "sum4" (35.0,-33.0) (Outside container379)
    out386 <- plugout' (sum4381 ++ "." ++ "result") (80.0,-108.0) (Outside container379)
    setColour out386 "#sample"
    container396 <- container' "panel_3x1.png" (0.0,192.0) (Inside root)
    in399 <- plugin' (butterlp398 ++ "." ++ "freq") (-21.0,217.0) (Outside container396)
    setColour in399 "#control"
    hide in399
    in400 <- plugin' (butterlp398 ++ "." ++ "signal") (-21.0,167.0) (Outside container396)
    setColour in400 "#sample"
    knob402 <- knob' (butterlp398_freq ++ "." ++ "result") (-21.0,217.0) (Outside container396)
    label397 <- label' "butterlp" (-25.0,267.0) (Outside container396)
    out401 <- plugout' (butterlp398 ++ "." ++ "result") (20.0,192.0) (Outside container396)
    setColour out401 "#sample"
    container47 <- container' "panel_filter.png" (-132.0,-36.0) (Inside root)
    in48 <- plugin' (vca44 ++ "." ++ "cv") (-144.0,84.0) (Outside container47)
    setColour in48 "#sample"
    hide in48
    in49 <- plugin' (vca44 ++ "." ++ "signal") (-192.0,24.0) (Outside container47)
    setColour in49 "#control"
    in50 <- plugin' (vca45 ++ "." ++ "cv") (-149.0,-38.0) (Outside container47)
    setColour in50 "#sample"
    hide in50
    in51 <- plugin' (vca45 ++ "." ++ "signal") (-192.0,-36.0) (Outside container47)
    setColour in51 "#control"
    in52 <- plugin' (vca46 ++ "." ++ "cv") (-151.0,-154.0) (Outside container47)
    setColour in52 "#sample"
    hide in52
    in53 <- plugin' (vca46 ++ "." ++ "signal") (-192.0,-96.0) (Outside container47)
    setColour in53 "#control"
    in54 <- plugin' (id33 ++ "." ++ "signal") (-192.0,84.0) (Outside container47)
    setColour in54 "#control"
    knob55 <- knob' (input40 ++ "." ++ "result") (-108.0,24.0) (Outside container47)
    setLow knob55 (Just (-1.0))
    setHigh  knob55 (Just (1.0))
    knob56 <- knob' (input34 ++ "." ++ "result") (-156.0,24.0) (Outside container47)
    knob57 <- knob' (input35 ++ "." ++ "result") (-156.0,-36.0) (Outside container47)
    knob58 <- knob' (input36 ++ "." ++ "result") (-108.0,-36.0) (Outside container47)
    setLow knob58 (Just (-1.0))
    setHigh  knob58 (Just (1.0))
    knob59 <- knob' (input37 ++ "." ++ "result") (-156.0,-96.0) (Outside container47)
    knob60 <- knob' (input38 ++ "." ++ "result") (-108.0,-96.0) (Outside container47)
    setLow knob60 (Just (-1.0))
    setHigh  knob60 (Just (1.0))
    knob61 <- knob' (input39 ++ "." ++ "result") (-108.0,-144.0) (Outside container47)
    setLow knob61 (Just (1.0))
    setHigh  knob61 (Just (1000.0))
    out62 <- plugout' (butterbp30 ++ "." ++ "result") (-72.0,-96.0) (Outside container47)
    setColour out62 "#sample"
    out63 <- plugout' (butterlp32 ++ "." ++ "result") (-72.0,24.0) (Outside container47)
    setColour out63 "#sample"
    out64 <- plugout' (butterhp31 ++ "." ++ "result") (-72.0,-36.0) (Outside container47)
    setColour out64 "#sample"
    proxy65 <- proxy' (-83.0,74.0) (Outside container47)
    hide proxy65
    ...
    in2 <- plugin' (out ++ "." ++ "value") (518.0,128.0) (Inside root)
    setOutput in2
