do
    ...
    random105 <- new' "random"
    sample_and_hold106 <- new' "sample_and_hold"
    sum107 <- new' "sum"
    sum108 <- new' "sum"
    sum109 <- new' "sum"
    sum110 <- new' "sum"
    ...
    plugin145 <- plugin' (sum107 ! "signal2") (-464.0,90.0) (Inside container134)
    setColour plugin145 "#sample"
    plugin146 <- plugin' (sum107 ! "signal1") (-464.0,140.0) (Inside container134)
    ...
    plugin156 <- plugin' (id12 ! "signal") (-381.0,-126.0) (Inside container134)
    setColour plugin156 "#sample"
    plugin157 <- plugin' (id13 ! "signal") (12.0,98.0) (Inside container134)
    setColour plugin157 "#sample"
    plugin158 <- plugin' (id68 ! "signal") (125.0,-32.0) (Inside container134)
    setColour plugin158 "#sample"
    plugin159 <- plugin' (id69 ! "signal") (-184.0,125.0) (Inside container134)
    setColour plugin159 "#sample"
    plugout160 <- plugout' (sum107 ! "result") (-423.0,115.0) (Inside container134)
    ...
    plugout165 <- plugout' (id70 ! "result") (-519.0,89.0) (Inside container134)
    setColour plugout165 "#sample"
    plugout166 <- plugout' (id71 ! "result") (-520.0,145.0) (Inside container134)
    setColour plugout166 "#sample"
    plugout167 <- plugout' (id9 ! "result") (-522.0,-125.0) (Inside container134)
    setColour plugout167 "#sample"
    plugout168 <- plugout' (id11 ! "result") (-521.0,-178.0) (Inside container134)
    setColour plugout168 "#sample"
    knob169 <- knob' (input97 ! "result") (-216.0,-60.0) (Outside container134)
    setLow knob169 (Just (0.0))
    setHigh  knob169 (Just (1.0))
    plugin170 <- plugin' (id70 ! "signal") (-216.0,-24.0) (Outside container134)
    setColour plugin170 "#control"
    plugin171 <- plugin' (id71 ! "signal") (-216.0,12.0) (Outside container134)
    setColour plugin171 "#sample"
    plugin172 <- plugin' (id9 ! "signal") (-216.0,-60.0) (Outside container134)
    setColour plugin172 "#sample"
    hide plugin172
    plugin173 <- plugin' (id11 ! "signal") (-216.0,-96.0) (Outside container134)
    setColour plugin173 "#control"
    plugout174 <- plugout' (id69 ! "result") (-276.0,-144.0) (Outside container134)
    setColour plugout174 "#sample"
    plugout175 <- plugout' (id12 ! "result") (-204.0,-144.0) (Outside container134)
    setColour plugout175 "#sample"
    plugout176 <- plugout' (id13 ! "result") (-276.0,-180.0) (Outside container134)
    setColour plugout176 "#sample"
    plugout177 <- plugout' (id68 ! "result") (-204.0,-180.0) (Outside container134)
    ...
    plugin189 <- plugin' (sum108 ! "signal2") (-464.0,90.0) (Inside container178)
    setColour plugin189 "#sample"
    plugin190 <- plugin' (sum108 ! "signal1") (-464.0,140.0) (Inside container178)
    ...
    plugin200 <- plugin' (id26 ! "signal") (-381.0,-126.0) (Inside container178)
    setColour plugin200 "#sample"
    plugin201 <- plugin' (id27 ! "signal") (12.0,98.0) (Inside container178)
    setColour plugin201 "#sample"
    plugin202 <- plugin' (id19 ! "signal") (125.0,-32.0) (Inside container178)
    setColour plugin202 "#sample"
    plugin203 <- plugin' (id20 ! "signal") (-184.0,125.0) (Inside container178)
    setColour plugin203 "#sample"
    plugout204 <- plugout' (sum108 ! "result") (-423.0,115.0) (Inside container178)
    ...
    plugout209 <- plugout' (id21 ! "result") (-519.0,89.0) (Inside container178)
    setColour plugout209 "#sample"
    plugout210 <- plugout' (id22 ! "result") (-520.0,145.0) (Inside container178)
    setColour plugout210 "#sample"
    plugout211 <- plugout' (id23 ! "result") (-522.0,-125.0) (Inside container178)
    setColour plugout211 "#sample"
    plugout212 <- plugout' (id25 ! "result") (-521.0,-178.0) (Inside container178)
    setColour plugout212 "#sample"
    knob213 <- knob' (input98 ! "result") (-216.0,-348.0) (Outside container178)
    setLow knob213 (Just (0.0))
    setHigh  knob213 (Just (1.0))
    plugin214 <- plugin' (id21 ! "signal") (-216.0,-312.0) (Outside container178)
    setColour plugin214 "#control"
    plugin215 <- plugin' (id22 ! "signal") (-216.0,-276.0) (Outside container178)
    setColour plugin215 "#sample"
    plugin216 <- plugin' (id23 ! "signal") (-216.0,-348.0) (Outside container178)
    setColour plugin216 "#sample"
    hide plugin216
    plugin217 <- plugin' (id25 ! "signal") (-216.0,-384.0) (Outside container178)
    setColour plugin217 "#control"
    plugout218 <- plugout' (id20 ! "result") (-276.0,-432.0) (Outside container178)
    setColour plugout218 "#sample"
    plugout219 <- plugout' (id26 ! "result") (-204.0,-432.0) (Outside container178)
    setColour plugout219 "#sample"
    plugout220 <- plugout' (id27 ! "result") (-276.0,-468.0) (Outside container178)
    setColour plugout220 "#sample"
    plugout221 <- plugout' (id19 ! "result") (-204.0,-468.0) (Outside container178)
    setColour plugout221 "#sample"
    container222 <- container' "panel_ladder.png" (108.0,-468.0) (Inside container133)
    plugin223 <- plugin' (ladder99 ! "freq") (-288.0,-60.0) (Inside container222)
    setColour plugin223 "#sample"
    hide plugin223
    plugout224 <- plugout' (sum109 ! "result") (-348.0,-60.0) (Inside container222)
    setColour plugout224 "#sample"
    hide plugout224
    plugin225 <- plugin' (ladder99 ! "signal") (60.0,-588.0) (Outside container222)
    setColour plugin225 "#sample"
    plugin226 <- plugin' (sum109 ! "signal1") (156.0,-396.0) (Outside container222)
    setColour plugin226 "#sample"
    plugin227 <- plugin' (sum109 ! "signal2") (108.0,-396.0) (Outside container222)
    setColour plugin227 "#control"
    plugin228 <- plugin' (ladder99 ! "res") (156.0,-456.0) (Outside container222)
    setColour plugin228 "#sample"
    plugout229 <- plugout' (ladder99 ! "result") (156.0,-588.0) (Outside container222)
    setColour plugout229 "#sample"
    container230 <- container' "panel_sum4.png" (-60.0,-276.0) (Inside container133)
    plugin231 <- plugin' (sum4113 ! "signal1") (-120.0,-204.0) (Outside container230)
    setColour plugin231 "#sample"
    plugin232 <- plugin' (sum4113 ! "signal2") (-120.0,-252.0) (Outside container230)
    setColour plugin232 "#sample"
    plugin233 <- plugin' (sum4113 ! "signal3") (-120.0,-300.0) (Outside container230)
    setColour plugin233 "#sample"
    plugin234 <- plugin' (sum4113 ! "signal4") (-120.0,-348.0) (Outside container230)
    setColour plugin234 "#sample"
    plugout235 <- plugout' (sum4113 ! "result") (0.0,-276.0) (Outside container230)
    setColour plugout235 "#sample"
    container236 <- container' "panel_adsr.png" (300.0,-60.0) (Inside container133)
    knob237 <- knob' (input74 ! "result") (276.0,0.0) (Outside container236)
    setLow knob237 (Just (0.0))
    knob238 <- knob' (input75 ! "result") (336.0,0.0) (Outside container236)
    setLow knob238 (Just (0.0))
    knob239 <- knob' (input80 ! "result") (276.0,-48.0) (Outside container236)
    setLow knob239 (Just (0.0))
    knob240 <- knob' (input79 ! "result") (336.0,-48.0) (Outside container236)
    ...
    knob248 <- knob' (input82 ! "result") (-708.0,240.0) (Outside container247)
    plugin249 <- plugin' (lfo100 ! "sync") (-708.0,192.0) (Outside container247)
    setColour plugin249 "#control"
    plugin250 <- plugin' (lfo100 ! "rate") (-708.0,240.0) (Outside container247)
    setColour plugin250 "#control"
    hide plugin250
    plugout251 <- plugout' (lfo100 ! "triangle") (-732.0,48.0) (Outside container247)
    setColour plugout251 "#control"
    plugout252 <- plugout' (lfo100 ! "saw") (-672.0,48.0) (Outside container247)
    setColour plugout252 "#control"
    plugout253 <- plugout' (lfo100 ! "sin_result") (-732.0,84.0) (Outside container247)
    setColour plugout253 "#control"
    plugout254 <- plugout' (lfo100 ! "square_result") (-672.0,84.0) (Outside container247)
    ...
    plugout260 <- plugout' (noise102 ! "result") (-408.0,-552.0) (Outside container259)
    setColour plugout260 "#sample"
    container261 <- container' "panel_lfo.png" (-720.0,-144.0) (Inside container133)
    plugin262 <- plugin' (lfo101 ! "sync") (-708.0,-120.0) (Outside container261)
    setColour plugin262 "#control"
    plugin263 <- plugin' (lfo101 ! "rate") (-708.0,-72.0) (Outside container261)
    setColour plugin263 "#control"
    plugout264 <- plugout' (lfo101 ! "triangle") (-732.0,-264.0) (Outside container261)
    setColour plugout264 "#control"
    plugout265 <- plugout' (lfo101 ! "saw") (-672.0,-264.0) (Outside container261)
    setColour plugout265 "#control"
    plugout266 <- plugout' (lfo101 ! "sin_result") (-732.0,-228.0) (Outside container261)
    setColour plugout266 "#control"
    plugout267 <- plugout' (lfo101 ! "square_result") (-672.0,-228.0) (Outside container261)
    setColour plugout267 "#control"
    container268 <- container' "panel_gain.png" (132.0,-84.0) (Inside container133)
    knob269 <- knob' (input87 ! "result") (108.0,-84.0) (Outside container268)
    ...
    plugin274 <- plugin' (sum110 ! "signal1") (60.0,-216.0) (Outside container273)
    setColour plugin274 "#sample"
    plugin275 <- plugin' (sum110 ! "signal2") (60.0,-264.0) (Outside container273)
    setColour plugin275 "#sample"
    plugout276 <- plugout' (sum110 ! "result") (180.0,-240.0) (Outside container273)
    setColour plugout276 "#sample"
    container277 <- container' "panel_mock_back.png" (-24.0,264.0) (Inside container133)
    plugin278 <- plugin' (id45 ! "signal") (96.0,120.0) (Outside container277)
    setColour plugin278 "#sample"
    plugin279 <- plugin' (id53 ! "signal") (144.0,120.0) (Outside container277)
    setColour plugin279 "#sample"
    plugin280 <- plugin' (id50 ! "signal") (240.0,120.0) (Outside container277)
    setColour plugin280 "#sample"
    plugin281 <- plugin' (id60 ! "signal") (192.0,120.0) (Outside container277)
    setColour plugin281 "#sample"
    plugin282 <- plugin' (id34 ! "signal") (-288.0,312.0) (Outside container277)
    setColour plugin282 "#control"
    plugin283 <- plugin' (id65 ! "signal") (-240.0,312.0) (Outside container277)
    setColour plugin283 "#control"
    plugin284 <- plugin' (id32 ! "signal") (-192.0,312.0) (Outside container277)
    setColour plugin284 "#control"
    plugin285 <- plugin' (id64 ! "signal") (0.0,312.0) (Outside container277)
    setColour plugin285 "#control"
    plugin286 <- plugin' (id63 ! "signal") (-48.0,312.0) (Outside container277)
    setColour plugin286 "#control"
    plugin287 <- plugin' (id62 ! "signal") (-96.0,312.0) (Outside container277)
    setColour plugin287 "#control"
    plugin288 <- plugin' (id47 ! "signal") (-144.0,312.0) (Outside container277)
    setColour plugin288 "#control"
    plugin289 <- plugin' (id15 ! "signal") (192.0,312.0) (Outside container277)
    setColour plugin289 "#control"
    plugin290 <- plugin' (id14 ! "signal") (144.0,312.0) (Outside container277)
    setColour plugin290 "#control"
    plugin291 <- plugin' (id67 ! "signal") (96.0,312.0) (Outside container277)
    setColour plugin291 "#control"
    plugin292 <- plugin' (id66 ! "signal") (48.0,312.0) (Outside container277)
    setColour plugin292 "#control"
    plugin293 <- plugin' (id17 ! "signal") (240.0,312.0) (Outside container277)
    setColour plugin293 "#control"
    plugin294 <- plugin' (id61 ! "signal") (276.0,264.0) (Outside container277)
    setColour plugin294 "#control"
    plugout295 <- plugout' (id40 ! "result") (144.0,408.0) (Outside container277)
    setColour plugout295 "#control"
    plugout296 <- plugout' (id39 ! "result") (96.0,408.0) (Outside container277)
    setColour plugout296 "#control"
    plugout297 <- plugout' (id38 ! "result") (48.0,408.0) (Outside container277)
    setColour plugout297 "#control"
    plugout298 <- plugout' (id46 ! "result") (240.0,408.0) (Outside container277)
    setColour plugout298 "#control"
    plugout299 <- plugout' (id18 ! "result") (120.0,168.0) (Outside container277)
    setColour plugout299 "#control"
    plugout300 <- plugout' (id24 ! "result") (216.0,168.0) (Outside container277)
    setColour plugout300 "#control"
    plugout301 <- plugout' (id48 ! "result") (-324.0,288.0) (Outside container277)
    setColour plugout301 "#control"
    plugout302 <- plugout' (id49 ! "result") (-324.0,240.0) (Outside container277)
    setColour plugout302 "#control"
    plugout303 <- plugout' (id52 ! "result") (240.0,216.0) (Outside container277)
    setColour plugout303 "#sample"
    plugout304 <- plugout' (id51 ! "result") (192.0,216.0) (Outside container277)
    setColour plugout304 "#sample"
    plugout305 <- plugout' (id59 ! "result") (144.0,216.0) (Outside container277)
    setColour plugout305 "#sample"
    plugout306 <- plugout' (id56 ! "result") (96.0,216.0) (Outside container277)
    setColour plugout306 "#sample"
    plugout307 <- plugout' (id28 ! "result") (-264.0,360.0) (Outside container277)
    setColour plugout307 "#control"
    plugout308 <- plugout' (id37 ! "result") (-168.0,360.0) (Outside container277)
    setColour plugout308 "#control"
    plugout309 <- plugout' (id44 ! "result") (-72.0,360.0) (Outside container277)
    setColour plugout309 "#control"
    plugout310 <- plugout' (id10 ! "result") (24.0,360.0) (Outside container277)
    setColour plugout310 "#control"
    plugout311 <- plugout' (id16 ! "result") (120.0,360.0) (Outside container277)
    setColour plugout311 "#control"
    plugout312 <- plugout' (id30 ! "result") (216.0,360.0) (Outside container277)
    setColour plugout312 "#control"
    plugout313 <- plugout' (id33 ! "result") (-288.0,408.0) (Outside container277)
    setColour plugout313 "#control"
    plugout314 <- plugout' (id41 ! "result") (-240.0,408.0) (Outside container277)
    setColour plugout314 "#control"
    plugout315 <- plugout' (id31 ! "result") (-192.0,408.0) (Outside container277)
    setColour plugout315 "#control"
    plugout316 <- plugout' (id42 ! "result") (-144.0,408.0) (Outside container277)
    setColour plugout316 "#control"
    plugout317 <- plugout' (id29 ! "result") (-96.0,408.0) (Outside container277)
    setColour plugout317 "#control"
    plugout318 <- plugout' (id36 ! "result") (0.0,408.0) (Outside container277)
    setColour plugout318 "#control"
    plugout319 <- plugout' (id35 ! "result") (-48.0,408.0) (Outside container277)
    setColour plugout319 "#control"
    plugout320 <- plugout' (id43 ! "result") (192.0,408.0) (Outside container277)
    ...
    knob327 <- knob' (input89 ! "result") (12.0,132.0) (Outside container326)
    plugin328 <- plugin' (one_pole103 ! "freq") (12.0,132.0) (Outside container326)
    setColour plugin328 "#control"
    hide plugin328
    plugin329 <- plugin' (one_pole103 ! "signal") (-12.0,24.0) (Outside container326)
    setColour plugin329 "#sample"
    plugout330 <- plugout' (one_pole103 ! "result") (36.0,24.0) (Outside container326)
    setColour plugout330 "#sample"
    plugin331 <- plugin' (id55 ! "signal") (140.0,55.0) (Inside container325)
    setColour plugin331 "#control"
    plugout332 <- plugout' (id54 ! "result") (-119.0,67.0) (Inside container325)
    setColour plugout332 "#control"
    plugin333 <- plugin' (id54 ! "signal") (-840.0,-360.0) (Outside container325)
    setColour plugin333 "#control"
    plugout334 <- plugout' (id55 ! "result") (-804.0,-360.0) (Outside container325)
    ...
    plugin341 <- plugin' (random105 ! "rate") (-852.0,-468.0) (Outside container339)
    setColour plugin341 "#control"
    plugout342 <- plugout' (random105 ! "result") (-804.0,-468.0) (Outside container339)
    ...
    knob345 <- knob' (input91 ! "result") (12.0,132.0) (Outside container344)
    plugin346 <- plugin' (one_pole104 ! "freq") (12.0,132.0) (Outside container344)
    setColour plugin346 "#control"
    hide plugin346
    plugin347 <- plugin' (one_pole104 ! "signal") (-12.0,24.0) (Outside container344)
    setColour plugin347 "#sample"
    plugout348 <- plugout' (one_pole104 ! "result") (36.0,24.0) (Outside container344)
    setColour plugout348 "#sample"
    plugin349 <- plugin' (id58 ! "signal") (140.0,55.0) (Inside container343)
    setColour plugin349 "#control"
    plugout350 <- plugout' (id57 ! "result") (-119.0,67.0) (Inside container343)
    setColour plugout350 "#control"
    knob351 <- knob' (input90 ! "result") (-948.0,276.0) (Outside container343)
    plugin352 <- plugin' (id57 ! "signal") (-948.0,276.0) (Outside container343)
    setColour plugin352 "#control"
    hide plugin352
    plugout353 <- plugout' (id58 ! "result") (-912.0,276.0) (Outside container343)
    ...
    plugin359 <- plugin' (sample_and_hold106 ! "trigger") (468.0,420.0) (Outside container358)
    setColour plugin359 "#control"
    plugin360 <- plugin' (sample_and_hold106 ! "signal") (408.0,396.0) (Outside container358)
    setColour plugin360 "#control"
    plugout361 <- plugout' (sample_and_hold106 ! "result") (528.0,396.0) (Outside container358)
    setColour plugout361 "#control"
    container362 <- container' "panel_int_add.png" (-396.0,48.0) (Inside container133)
    plugin363 <- plugin' (sum111 ! "signal1") (-456.0,72.0) (Outside container362)
    setColour plugin363 "#sample"
    plugin364 <- plugin' (sum111 ! "signal2") (-456.0,24.0) (Outside container362)
    setColour plugin364 "#sample"
    plugout365 <- plugout' (sum111 ! "result") (-336.0,48.0) (Outside container362)
    setColour plugout365 "#sample"
    container366 <- container' "panel_int_add.png" (-396.0,-240.0) (Inside container133)
    plugin367 <- plugin' (sum112 ! "signal1") (-456.0,-216.0) (Outside container366)
    setColour plugin367 "#sample"
    plugin368 <- plugin' (sum112 ! "signal2") (-456.0,-264.0) (Outside container366)
    setColour plugin368 "#sample"
    plugout369 <- plugout' (sum112 ! "result") (-336.0,-240.0) (Outside container366)
    setColour plugout369 "#sample"
    container370 <- container' "panel_gain.png" (-396.0,-24.0) (Inside container133)
    knob371 <- knob' (input94 ! "result") (-420.0,-24.0) (Outside container370)
    ...
    knob376 <- knob' (input95 ! "result") (-420.0,-312.0) (Outside container375)
    ...
    knob381 <- knob' (input96 ! "result") (-744.0,-540.0) (Outside container380)
    ...
    knob390 <- knob' (input76 ! "result") (240.0,-396.0) (Outside container389)
    ...
    knob395 <- knob' (input77 ! "result") (-348.0,-552.0) (Outside container394)
    ...
    knob400 <- knob' (input72 ! "result") (-960.0,-360.0) (Outside container399)
    ...
    knob409 <- knob' (input115 ! "result") (420.0,-396.0) (Outside container408)
    ...
    knob413 <- knob' (input88 ! "result") (-216.0,96.0) (Outside container133)
    knob414 <- knob' (input81 ! "result") (-120.0,96.0) (Outside container133)
    knob415 <- knob' (input83 ! "result") (-24.0,96.0) (Outside container133)
    knob416 <- knob' (input84 ! "result") (72.0,96.0) (Outside container133)
    knob417 <- knob' (input85 ! "result") (168.0,96.0) (Outside container133)
    knob418 <- knob' (input86 ! "result") (264.0,96.0) (Outside container133)
    knob419 <- knob' (input73 ! "result") (168.0,-96.0) (Outside container133)
    knob420 <- knob' (input78 ! "result") (264.0,-96.0) (Outside container133)
    plugin421 <- plugin' (id18 ! "signal") (168.0,-96.0) (Outside container133)
    setColour plugin421 "#control"
    hide plugin421
    plugin422 <- plugin' (id24 ! "signal") (264.0,-96.0) (Outside container133)
    setColour plugin422 "#control"
    hide plugin422
    plugin423 <- plugin' (id48 ! "signal") (-276.0,24.0) (Outside container133)
    setColour plugin423 "#control"
    plugin424 <- plugin' (id49 ! "signal") (-276.0,-24.0) (Outside container133)
    setColour plugin424 "#control"
    plugin425 <- plugin' (id33 ! "signal") (-240.0,144.0) (Outside container133)
    setColour plugin425 "#control"
    plugin426 <- plugin' (id41 ! "signal") (-192.0,144.0) (Outside container133)
    setColour plugin426 "#control"
    plugin427 <- plugin' (id31 ! "signal") (-144.0,144.0) (Outside container133)
    setColour plugin427 "#control"
    plugin428 <- plugin' (id28 ! "signal") (-216.0,96.0) (Outside container133)
    setColour plugin428 "#control"
    hide plugin428
    plugin429 <- plugin' (id37 ! "signal") (-120.0,96.0) (Outside container133)
    setColour plugin429 "#control"
    hide plugin429
    plugin430 <- plugin' (id44 ! "signal") (-24.0,96.0) (Outside container133)
    setColour plugin430 "#control"
    hide plugin430
    plugin431 <- plugin' (id10 ! "signal") (72.0,96.0) (Outside container133)
    setColour plugin431 "#control"
    hide plugin431
    plugin432 <- plugin' (id16 ! "signal") (168.0,96.0) (Outside container133)
    setColour plugin432 "#control"
    hide plugin432
    plugin433 <- plugin' (id30 ! "signal") (264.0,96.0) (Outside container133)
    setColour plugin433 "#control"
    hide plugin433
    plugin434 <- plugin' (id42 ! "signal") (-96.0,144.0) (Outside container133)
    setColour plugin434 "#control"
    plugin435 <- plugin' (id29 ! "signal") (-48.0,144.0) (Outside container133)
    setColour plugin435 "#control"
    plugin436 <- plugin' (id36 ! "signal") (48.0,144.0) (Outside container133)
    setColour plugin436 "#control"
    plugin437 <- plugin' (id35 ! "signal") (0.0,144.0) (Outside container133)
    setColour plugin437 "#control"
    plugin438 <- plugin' (id43 ! "signal") (240.0,144.0) (Outside container133)
    setColour plugin438 "#control"
    plugin439 <- plugin' (id40 ! "signal") (192.0,144.0) (Outside container133)
    setColour plugin439 "#control"
    plugin440 <- plugin' (id39 ! "signal") (144.0,144.0) (Outside container133)
    setColour plugin440 "#control"
    plugin441 <- plugin' (id38 ! "signal") (96.0,144.0) (Outside container133)
    setColour plugin441 "#control"
    plugin442 <- plugin' (id46 ! "signal") (288.0,144.0) (Outside container133)
    setColour plugin442 "#control"
    plugin443 <- plugin' (id59 ! "signal") (192.0,-48.0) (Outside container133)
    setColour plugin443 "#sample"
    plugin444 <- plugin' (id51 ! "signal") (240.0,-48.0) (Outside container133)
    setColour plugin444 "#sample"
    plugin445 <- plugin' (id52 ! "signal") (288.0,-48.0) (Outside container133)
    setColour plugin445 "#sample"
    plugin446 <- plugin' (id56 ! "signal") (144.0,-48.0) (Outside container133)
    setColour plugin446 "#sample"
    plugout447 <- plugout' (id34 ! "result") (-240.0,48.0) (Outside container133)
    setColour plugout447 "#control"
    plugout448 <- plugout' (id65 ! "result") (-192.0,48.0) (Outside container133)
    setColour plugout448 "#control"
    plugout449 <- plugout' (id32 ! "result") (-144.0,48.0) (Outside container133)
    setColour plugout449 "#control"
    plugout450 <- plugout' (id64 ! "result") (48.0,48.0) (Outside container133)
    setColour plugout450 "#control"
    plugout451 <- plugout' (id63 ! "result") (0.0,48.0) (Outside container133)
    setColour plugout451 "#control"
    plugout452 <- plugout' (id62 ! "result") (-48.0,48.0) (Outside container133)
    setColour plugout452 "#control"
    plugout453 <- plugout' (id47 ! "result") (-96.0,48.0) (Outside container133)
    setColour plugout453 "#control"
    plugout454 <- plugout' (id15 ! "result") (240.0,48.0) (Outside container133)
    setColour plugout454 "#control"
    plugout455 <- plugout' (id14 ! "result") (192.0,48.0) (Outside container133)
    setColour plugout455 "#control"
    plugout456 <- plugout' (id67 ! "result") (144.0,48.0) (Outside container133)
    setColour plugout456 "#control"
    plugout457 <- plugout' (id66 ! "result") (96.0,48.0) (Outside container133)
    setColour plugout457 "#control"
    plugout458 <- plugout' (id17 ! "result") (288.0,48.0) (Outside container133)
    setColour plugout458 "#control"
    plugout459 <- plugout' (id61 ! "result") (324.0,0.0) (Outside container133)
    setColour plugout459 "#control"
    plugout460 <- plugout' (id53 ! "result") (192.0,-144.0) (Outside container133)
    setColour plugout460 "#sample"
    plugout461 <- plugout' (id45 ! "result") (144.0,-144.0) (Outside container133)
    setColour plugout461 "#sample"
    plugout462 <- plugout' (id50 ! "result") (288.0,-144.0) (Outside container133)
    setColour plugout462 "#sample"
    plugout463 <- plugout' (id60 ! "result") (240.0,-144.0) (Outside container133)
    setColour plugout463 "#sample"
    container464 <- container' "panel_keyboard.png" (-408.0,0.0) (Inside root)
    plugout465 <- plugout' (input92 ! "result") (-348.0,24.0) (Outside container464)
    setColour plugout465 "#control"
    plugout466 <- plugout' (input93 ! "result") (-348.0,-24.0) (Outside container464)
    ...
    alias "in-8" id38
    alias "in-9" id39
    alias "keyboard" input92
    alias "knob-1" input88
    alias "knob-2" input81
    alias "knob-3" input83
    alias "knob-4" input84
    alias "knob-5" input85
    alias "knob-6" input86
    alias "knob-7" input73
    alias "knob-8" input78
    alias "out-13" id34
    alias "out-14" id65
    alias "out-15" id32
    alias "out-16" id47
