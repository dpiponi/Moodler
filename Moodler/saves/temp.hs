do
    ...
    plugin178 <- plugin' "id50.signal" (1632.0,-1140.0) (Outside container177)
    setColour plugin178 "#sample"
    plugin179 <- plugin' "id51.signal" (1680.0,-1140.0) (Outside container177)
    setColour plugin179 "#sample"
    plugin180 <- plugin' "id90.signal" (1776.0,-1140.0) (Outside container177)
    setColour plugin180 "#sample"
    plugin181 <- plugin' "id54.signal" (1728.0,-1140.0) (Outside container177)
    setColour plugin181 "#sample"
    plugin182 <- plugin' "id75.signal" (1248.0,-948.0) (Outside container177)
    setColour plugin182 "#control"
    plugin183 <- plugin' "id59.signal" (1296.0,-948.0) (Outside container177)
    setColour plugin183 "#control"
    plugin184 <- plugin' "id73.signal" (1344.0,-948.0) (Outside container177)
    setColour plugin184 "#control"
    plugin185 <- plugin' "id58.signal" (1536.0,-948.0) (Outside container177)
    setColour plugin185 "#control"
    plugin186 <- plugin' "id57.signal" (1488.0,-948.0) (Outside container177)
    setColour plugin186 "#control"
    plugin187 <- plugin' "id56.signal" (1440.0,-948.0) (Outside container177)
    setColour plugin187 "#control"
    plugin188 <- plugin' "id87.signal" (1392.0,-948.0) (Outside container177)
    setColour plugin188 "#control"
    plugin189 <- plugin' "id64.signal" (1728.0,-948.0) (Outside container177)
    setColour plugin189 "#control"
    plugin190 <- plugin' "id63.signal" (1680.0,-948.0) (Outside container177)
    setColour plugin190 "#control"
    plugin191 <- plugin' "id61.signal" (1632.0,-948.0) (Outside container177)
    setColour plugin191 "#control"
    plugin192 <- plugin' "id60.signal" (1584.0,-948.0) (Outside container177)
    setColour plugin192 "#control"
    plugin193 <- plugin' "id66.signal" (1776.0,-948.0) (Outside container177)
    setColour plugin193 "#control"
    plugin194 <- plugin' "id55.signal" (1812.0,-996.0) (Outside container177)
    setColour plugin194 "#control"
    plugout195 <- plugout' "id81.result" (1680.0,-852.0) (Outside container177)
    setColour plugout195 "#control"
    plugout196 <- plugout' "id80.result" (1632.0,-852.0) (Outside container177)
    setColour plugout196 "#control"
    plugout197 <- plugout' "id79.result" (1584.0,-852.0) (Outside container177)
    setColour plugout197 "#control"
    plugout198 <- plugout' "id86.result" (1776.0,-852.0) (Outside container177)
    setColour plugout198 "#control"
    plugout199 <- plugout' "id67.result" (1656.0,-1092.0) (Outside container177)
    setColour plugout199 "#control"
    plugout200 <- plugout' "id68.result" (1752.0,-1092.0) (Outside container177)
    setColour plugout200 "#control"
    plugout201 <- plugout' "id88.result" (1212.0,-972.0) (Outside container177)
    setColour plugout201 "#control"
    plugout202 <- plugout' "id89.result" (1212.0,-1020.0) (Outside container177)
    setColour plugout202 "#control"
    plugout203 <- plugout' "id92.result" (1776.0,-1044.0) (Outside container177)
    setColour plugout203 "#sample"
    plugout204 <- plugout' "id91.result" (1728.0,-1044.0) (Outside container177)
    setColour plugout204 "#sample"
    plugout205 <- plugout' "id53.result" (1680.0,-1044.0) (Outside container177)
    setColour plugout205 "#sample"
    plugout206 <- plugout' "id52.result" (1632.0,-1044.0) (Outside container177)
    setColour plugout206 "#sample"
    plugout207 <- plugout' "id69.result" (1272.0,-900.0) (Outside container177)
    setColour plugout207 "#control"
    plugout208 <- plugout' "id78.result" (1368.0,-900.0) (Outside container177)
    setColour plugout208 "#control"
    plugout209 <- plugout' "id85.result" (1464.0,-900.0) (Outside container177)
    setColour plugout209 "#control"
    plugout210 <- plugout' "id62.result" (1560.0,-900.0) (Outside container177)
    setColour plugout210 "#control"
    plugout211 <- plugout' "id65.result" (1656.0,-900.0) (Outside container177)
    setColour plugout211 "#control"
    plugout212 <- plugout' "id71.result" (1752.0,-900.0) (Outside container177)
    setColour plugout212 "#control"
    plugout213 <- plugout' "id74.result" (1248.0,-852.0) (Outside container177)
    setColour plugout213 "#control"
    plugout214 <- plugout' "id82.result" (1296.0,-852.0) (Outside container177)
    setColour plugout214 "#control"
    plugout215 <- plugout' "id72.result" (1344.0,-852.0) (Outside container177)
    setColour plugout215 "#control"
    plugout216 <- plugout' "id83.result" (1392.0,-852.0) (Outside container177)
    setColour plugout216 "#control"
    plugout217 <- plugout' "id70.result" (1440.0,-852.0) (Outside container177)
    setColour plugout217 "#control"
    plugout218 <- plugout' "id77.result" (1536.0,-852.0) (Outside container177)
    setColour plugout218 "#control"
    plugout219 <- plugout' "id76.result" (1488.0,-852.0) (Outside container177)
    setColour plugout219 "#control"
    plugout220 <- plugout' "id84.result" (1728.0,-852.0) (Outside container177)
    setColour plugout220 "#control"
    container221 <- container' "warp12_out.png" (1608.0,-396.0) (Inside container176)
    plugout222 <- plugout' "audio_id22.result" (1632.0,-372.0) (Outside container221)
    setColour plugout222 "#sample"
    plugout223 <- plugout' "audio_id21.result" (1632.0,-324.0) (Outside container221)
    setColour plugout223 "#sample"
    plugout224 <- plugout' "audio_id12.result" (1632.0,-276.0) (Outside container221)
    setColour plugout224 "#sample"
    plugout225 <- plugout' "audio_id4.result" (1632.0,-228.0) (Outside container221)
    setColour plugout225 "#sample"
    plugout226 <- plugout' "audio_id16.result" (1632.0,-180.0) (Outside container221)
    setColour plugout226 "#sample"
    plugout227 <- plugout' "audio_id15.result" (1632.0,-132.0) (Outside container221)
    setColour plugout227 "#sample"
    plugout228 <- plugout' "audio_id11.result" (1632.0,-660.0) (Outside container221)
    ...
    plugout231 <- plugout' "audio_id17.result" (1632.0,-516.0) (Outside container221)
    setColour plugout231 "#sample"
    plugout232 <- plugout' "audio_id24.result" (1632.0,-468.0) (Outside container221)
    setColour plugout232 "#sample"
    plugout233 <- plugout' "audio_id23.result" (1632.0,-420.0) (Outside container221)
    setColour plugout233 "#sample"
    container234 <- container' "warp12_in.png" (1380.0,-384.0) (Inside container176)
    plugin235 <- plugin' "audio_id16.signal" (1356.0,-168.0) (Outside container234)
    setColour plugin235 "#sample"
    plugin236 <- plugin' "audio_id21.signal" (1356.0,-312.0) (Outside container234)
    setColour plugin236 "#sample"
    plugin237 <- plugin' "audio_id22.signal" (1356.0,-360.0) (Outside container234)
    setColour plugin237 "#sample"
    plugin238 <- plugin' "audio_id4.signal" (1356.0,-216.0) (Outside container234)
    setColour plugin238 "#sample"
    plugin239 <- plugin' "audio_id12.signal" (1356.0,-264.0) (Outside container234)
    setColour plugin239 "#sample"
    plugin240 <- plugin' "audio_id15.signal" (1356.0,-120.0) (Outside container234)
    setColour plugin240 "#sample"
    plugin241 <- plugin' "audio_id24.signal" (1356.0,-456.0) (Outside container234)
    setColour plugin241 "#sample"
    plugin242 <- plugin' "audio_id1.signal" (1356.0,-600.0) (Outside container234)
    setColour plugin242 "#sample"
    plugin243 <- plugin' "audio_id11.signal" (1356.0,-648.0) (Outside container234)
    setColour plugin243 "#sample"
    plugin244 <- plugin' "audio_id17.signal" (1356.0,-504.0) (Outside container234)
    setColour plugin244 "#sample"
    plugin245 <- plugin' "audio_id0.signal" (1356.0,-552.0) (Outside container234)
    setColour plugin245 "#sample"
    plugin246 <- plugin' "audio_id23.signal" (1356.0,-408.0) (Outside container234)
    ...
    plugout351 <- plugout' "audio_id9.result" (84.0,-744.0) (Outside container350)
    setColour plugout351 "#sample"
    plugout352 <- plugout' "audio_id8.result" (84.0,-696.0) (Outside container350)
    setColour plugout352 "#sample"
    plugout353 <- plugout' "audio_id7.result" (84.0,-648.0) (Outside container350)
    setColour plugout353 "#sample"
    plugout354 <- plugout' "audio_id20.result" (84.0,-600.0) (Outside container350)
    setColour plugout354 "#sample"
    plugout355 <- plugout' "audio_id13.result" (84.0,-552.0) (Outside container350)
    setColour plugout355 "#sample"
    plugout356 <- plugout' "audio_id5.result" (84.0,-504.0) (Outside container350)
    setColour plugout356 "#sample"
    plugout357 <- plugout' "audio_id6.result" (84.0,-1032.0) (Outside container350)
    setColour plugout357 "#sample"
    plugout358 <- plugout' "audio_id2.result" (84.0,-984.0) (Outside container350)
    setColour plugout358 "#sample"
    plugout359 <- plugout' "audio_id10.result" (84.0,-936.0) (Outside container350)
    setColour plugout359 "#sample"
    plugout360 <- plugout' "audio_id19.result" (84.0,-888.0) (Outside container350)
    setColour plugout360 "#sample"
    plugout361 <- plugout' "audio_id18.result" (84.0,-840.0) (Outside container350)
    setColour plugout361 "#sample"
    plugout362 <- plugout' "audio_id3.result" (84.0,-792.0) (Outside container350)
    setColour plugout362 "#sample"
    container363 <- container' "warp12_in.png" (1992.0,-384.0) (Inside container176)
    plugin364 <- plugin' "audio_id13.signal" (1968.0,-168.0) (Outside container363)
    setColour plugin364 "#sample"
    plugin365 <- plugin' "audio_id8.signal" (1968.0,-312.0) (Outside container363)
    setColour plugin365 "#sample"
    plugin366 <- plugin' "audio_id9.signal" (1968.0,-360.0) (Outside container363)
    setColour plugin366 "#sample"
    plugin367 <- plugin' "audio_id20.signal" (1968.0,-216.0) (Outside container363)
    setColour plugin367 "#sample"
    plugin368 <- plugin' "audio_id7.signal" (1968.0,-264.0) (Outside container363)
    setColour plugin368 "#sample"
    plugin369 <- plugin' "audio_id5.signal" (1968.0,-120.0) (Outside container363)
    setColour plugin369 "#sample"
    plugin370 <- plugin' "audio_id18.signal" (1968.0,-456.0) (Outside container363)
    setColour plugin370 "#sample"
    plugin371 <- plugin' "audio_id2.signal" (1968.0,-600.0) (Outside container363)
    setColour plugin371 "#sample"
    plugin372 <- plugin' "audio_id6.signal" (1968.0,-648.0) (Outside container363)
    setColour plugin372 "#sample"
    plugin373 <- plugin' "audio_id19.signal" (1968.0,-504.0) (Outside container363)
    setColour plugin373 "#sample"
    plugin374 <- plugin' "audio_id10.signal" (1968.0,-552.0) (Outside container363)
    setColour plugin374 "#sample"
    plugin375 <- plugin' "audio_id3.signal" (1968.0,-408.0) (Outside container363)
    ...
    plugin402 <- plugin' "id49.signal" (1080.0,-1176.0) (Outside container401)
    setColour plugin402 "#control"
    plugout403 <- plugout' "id49.result" (1116.0,-1176.0) (Outside container401)
    ...
    plugin411 <- plugin' "id42.signal" (84.0,-228.0) (Outside container404)
    setColour plugin411 "#control"
    hide plugin411
    plugin412 <- plugin' "id44.signal" (132.0,-228.0) (Outside container404)
    setColour plugin412 "#control"
    hide plugin412
    plugin413 <- plugin' "id45.signal" (180.0,-228.0) (Outside container404)
    setColour plugin413 "#control"
    hide plugin413
    plugin414 <- plugin' "id46.signal" (228.0,-228.0) (Outside container404)
    setColour plugin414 "#control"
    hide plugin414
    plugin415 <- plugin' "id47.signal" (-12.0,-228.0) (Outside container404)
    setColour plugin415 "#control"
    hide plugin415
    plugin416 <- plugin' "id43.signal" (36.0,-228.0) (Outside container404)
    setColour plugin416 "#control"
    hide plugin416
    plugout417 <- plugout' "id43.result" (36.0,-228.0) (Outside container404)
    setColour plugout417 "#control"
    plugout418 <- plugout' "id42.result" (84.0,-228.0) (Outside container404)
    setColour plugout418 "#control"
    plugout419 <- plugout' "id44.result" (132.0,-228.0) (Outside container404)
    setColour plugout419 "#control"
    plugout420 <- plugout' "id45.result" (180.0,-228.0) (Outside container404)
    setColour plugout420 "#control"
    plugout421 <- plugout' "id46.result" (228.0,-228.0) (Outside container404)
    setColour plugout421 "#control"
    plugout422 <- plugout' "id47.result" (-12.0,-228.0) (Outside container404)
    ...
    plugin450 <- plugin' "id98.signal" (84.0,288.0) (Outside container443)
    setColour plugin450 "#control"
    hide plugin450
    plugin451 <- plugin' "id100.signal" (132.0,288.0) (Outside container443)
    setColour plugin451 "#control"
    hide plugin451
    plugin452 <- plugin' "id101.signal" (180.0,288.0) (Outside container443)
    setColour plugin452 "#control"
    hide plugin452
    plugin453 <- plugin' "id38.signal" (228.0,288.0) (Outside container443)
    setColour plugin453 "#control"
    hide plugin453
    plugin454 <- plugin' "id39.signal" (-12.0,288.0) (Outside container443)
    setColour plugin454 "#control"
    hide plugin454
    plugin455 <- plugin' "id99.signal" (36.0,288.0) (Outside container443)
    setColour plugin455 "#control"
    hide plugin455
    plugout456 <- plugout' "id98.result" (84.0,288.0) (Outside container443)
    setColour plugout456 "#control"
    plugout457 <- plugout' "id100.result" (132.0,288.0) (Outside container443)
    setColour plugout457 "#control"
    plugout458 <- plugout' "id101.result" (180.0,288.0) (Outside container443)
    setColour plugout458 "#control"
    plugout459 <- plugout' "id38.result" (228.0,288.0) (Outside container443)
    setColour plugout459 "#control"
    plugout460 <- plugout' "id39.result" (-12.0,288.0) (Outside container443)
    setColour plugout460 "#control"
    plugout461 <- plugout' "id99.result" (36.0,288.0) (Outside container443)
    ...
    plugin469 <- plugin' "id96.signal" (228.0,48.0) (Outside container462)
    setColour plugin469 "#control"
    hide plugin469
    plugin470 <- plugin' "id97.signal" (-12.0,48.0) (Outside container462)
    setColour plugin470 "#control"
    hide plugin470
    plugin471 <- plugin' "id93.signal" (36.0,48.0) (Outside container462)
    setColour plugin471 "#control"
    hide plugin471
    plugin472 <- plugin' "id48.signal" (84.0,48.0) (Outside container462)
    setColour plugin472 "#control"
    hide plugin472
    plugin473 <- plugin' "id94.signal" (132.0,48.0) (Outside container462)
    setColour plugin473 "#control"
    hide plugin473
    plugin474 <- plugin' "id95.signal" (180.0,48.0) (Outside container462)
    setColour plugin474 "#control"
    hide plugin474
    plugout475 <- plugout' "id93.result" (36.0,48.0) (Outside container462)
    setColour plugout475 "#control"
    plugout476 <- plugout' "id48.result" (84.0,48.0) (Outside container462)
    setColour plugout476 "#control"
    plugout477 <- plugout' "id94.result" (132.0,48.0) (Outside container462)
    setColour plugout477 "#control"
    plugout478 <- plugout' "id95.result" (180.0,48.0) (Outside container462)
    setColour plugout478 "#control"
    plugout479 <- plugout' "id96.result" (228.0,48.0) (Outside container462)
    setColour plugout479 "#control"
    plugout480 <- plugout' "id97.result" (-12.0,48.0) (Outside container462)
    ...
    plugin523 <- plugin' "id40.signal" (1992.0,348.0) (Outside container521)
    setColour plugin523 "#control"
    hide plugin523
    plugout524 <- plugout' "id40.result" (2028.0,348.0) (Outside container521)
    ...
    plugin529 <- plugin' "audio_id14.signal" (2085.0,205.0) (Inside container176)
    setColour plugin529 "#sample"
    plugin530 <- plugin' "id41.signal" (-561.0,-228.0) (Inside container176)
    setColour plugin530 "#control"
    plugout531 <- plugout' "audio_id14.result" (2198.0,181.0) (Inside container176)
    setColour plugout531 "#sample"
    plugout532 <- plugout' "id41.result" (-304.0,-204.0) (Inside container176)
    ...
    plugin541 <- plugin' "id67.signal" (252.0,60.0) (Outside container176)
    setColour plugin541 "#control"
    hide plugin541
    plugin542 <- plugin' "id68.signal" (348.0,60.0) (Outside container176)
    setColour plugin542 "#control"
    hide plugin542
    plugin543 <- plugin' "id88.signal" (-192.0,180.0) (Outside container176)
    setColour plugin543 "#control"
    plugin544 <- plugin' "id89.signal" (-192.0,132.0) (Outside container176)
    setColour plugin544 "#control"
    plugin545 <- plugin' "id74.signal" (-156.0,300.0) (Outside container176)
    setColour plugin545 "#control"
    plugin546 <- plugin' "id82.signal" (-108.0,300.0) (Outside container176)
    setColour plugin546 "#control"
    plugin547 <- plugin' "id72.signal" (-60.0,300.0) (Outside container176)
    setColour plugin547 "#control"
    plugin548 <- plugin' "id69.signal" (-132.0,252.0) (Outside container176)
    setColour plugin548 "#control"
    hide plugin548
    plugin549 <- plugin' "id78.signal" (-36.0,252.0) (Outside container176)
    setColour plugin549 "#control"
    hide plugin549
    plugin550 <- plugin' "id85.signal" (60.0,252.0) (Outside container176)
    setColour plugin550 "#control"
    hide plugin550
    plugin551 <- plugin' "id62.signal" (156.0,252.0) (Outside container176)
    setColour plugin551 "#control"
    hide plugin551
    plugin552 <- plugin' "id65.signal" (252.0,252.0) (Outside container176)
    setColour plugin552 "#control"
    hide plugin552
    plugin553 <- plugin' "id71.signal" (348.0,252.0) (Outside container176)
    setColour plugin553 "#control"
    hide plugin553
    plugin554 <- plugin' "id83.signal" (-12.0,300.0) (Outside container176)
    setColour plugin554 "#control"
    plugin555 <- plugin' "id70.signal" (36.0,300.0) (Outside container176)
    setColour plugin555 "#control"
    plugin556 <- plugin' "id77.signal" (132.0,300.0) (Outside container176)
    setColour plugin556 "#control"
    plugin557 <- plugin' "id76.signal" (84.0,300.0) (Outside container176)
    setColour plugin557 "#control"
    plugin558 <- plugin' "id84.signal" (324.0,300.0) (Outside container176)
    setColour plugin558 "#control"
    plugin559 <- plugin' "id81.signal" (276.0,300.0) (Outside container176)
    setColour plugin559 "#control"
    plugin560 <- plugin' "id80.signal" (228.0,300.0) (Outside container176)
    setColour plugin560 "#control"
    plugin561 <- plugin' "id79.signal" (180.0,300.0) (Outside container176)
    setColour plugin561 "#control"
    plugin562 <- plugin' "id86.signal" (372.0,300.0) (Outside container176)
    setColour plugin562 "#control"
    plugin563 <- plugin' "id53.signal" (276.0,108.0) (Outside container176)
    setColour plugin563 "#sample"
    plugin564 <- plugin' "id91.signal" (324.0,108.0) (Outside container176)
    setColour plugin564 "#sample"
    plugin565 <- plugin' "id92.signal" (372.0,108.0) (Outside container176)
    setColour plugin565 "#sample"
    plugin566 <- plugin' "id52.signal" (228.0,108.0) (Outside container176)
    setColour plugin566 "#sample"
    plugout567 <- plugout' "id75.result" (-156.0,204.0) (Outside container176)
    setColour plugout567 "#control"
    plugout568 <- plugout' "id59.result" (-108.0,204.0) (Outside container176)
    setColour plugout568 "#control"
    plugout569 <- plugout' "id73.result" (-60.0,204.0) (Outside container176)
    setColour plugout569 "#control"
    plugout570 <- plugout' "id58.result" (132.0,204.0) (Outside container176)
    setColour plugout570 "#control"
    plugout571 <- plugout' "id57.result" (84.0,204.0) (Outside container176)
    setColour plugout571 "#control"
    plugout572 <- plugout' "id56.result" (36.0,204.0) (Outside container176)
    setColour plugout572 "#control"
    plugout573 <- plugout' "id87.result" (-12.0,204.0) (Outside container176)
    setColour plugout573 "#control"
    plugout574 <- plugout' "id64.result" (324.0,204.0) (Outside container176)
    setColour plugout574 "#control"
    plugout575 <- plugout' "id63.result" (276.0,204.0) (Outside container176)
    setColour plugout575 "#control"
    plugout576 <- plugout' "id61.result" (228.0,204.0) (Outside container176)
    setColour plugout576 "#control"
    plugout577 <- plugout' "id60.result" (180.0,204.0) (Outside container176)
    setColour plugout577 "#control"
    plugout578 <- plugout' "id66.result" (372.0,204.0) (Outside container176)
    setColour plugout578 "#control"
    plugout579 <- plugout' "id55.result" (408.0,156.0) (Outside container176)
    setColour plugout579 "#control"
    plugout580 <- plugout' "id51.result" (276.0,12.0) (Outside container176)
    setColour plugout580 "#sample"
    plugout581 <- plugout' "id50.result" (228.0,12.0) (Outside container176)
    setColour plugout581 "#sample"
    plugout582 <- plugout' "id90.result" (372.0,12.0) (Outside container176)
    setColour plugout582 "#sample"
    plugout583 <- plugout' "id54.result" (324.0,12.0) (Outside container176)
