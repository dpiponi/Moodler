do
    ...
    vca114 <- new' "vca"
    vca115 <- new' "vca"
    container116 <- container' "panel_sequencer.png" (-33.0,296.0) root
    ...
    container173 <- container' "panel_3x1.png" (266.0,-60.0) root
    ...
    container179 <- container' "panel_lfo.png" (-351.52,171.2345) root
