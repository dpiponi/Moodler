do
    ...
    knob153 <- knob' (input62 ++ "." ++ "result") (-12.0,192.0) container116
    ...
    in180 <- plugin' (lfo95 ++ "." ++ "sync") (-348.0,348.0) container179
    in181 <- plugin' (lfo95 ++ "." ++ "rate") (-346.52,410.2345) container179
    hide in181
    knob182 <- knob' (input74 ++ "." ++ "result") (-348.0,408.0) container179
