do
    ...
    container143 <- container' "panel_3x1.bmp" (372.0,48.0) root
    ...
    container148 <- container' "panel_ladder.bmp" (192.0,-168.0) root
    ...
    container89 <- container' "panel_vco2.bmp" (0.0,-312.0) root
